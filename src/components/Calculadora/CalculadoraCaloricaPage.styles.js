...
export const InfoCard = styled.div`
  ...
  p, ul {font-size: 1rem; color: #506068;}
  ul {margin-top: 0.8rem; margin-left: 1.1rem;}
`;
...
export const CTAButton = styled.a`
  ...
  &:hover { background: #2a6f61; transform: scale(1.07);}
`;
...
export const Recommendations = styled.div`
  ...
  h4 { color: #2a9d8f; font-size: 1.1rem; margin-bottom: 0.7rem;}
